            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 justify-center max-w-7xl mx-auto">
                    ...
                    >
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-1">
                          <Label htmlFor="demo-input" className="text-xs">
                            Sample Input
                          </Label>
                          <Input
                            id="demo-input"
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Elegant cards, progress indicators, and alert components
                          ...
                          <Card className="w-full">
                            ...
                            <CardContent>
                              <p className="text-sm text-muted-foreground">
                                This shows how components work together
                                seamlessly.
                              </p>
                            </CardContent>
                          </Card>
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Complex components like testimonial sliders and signature
                      capture with advanced animations.
                    </p>
                  </div>
                </div>
                      ...
                      {(() => {
                        const testimonials = [
                          ...
                          },
                          {
                            ...
                            quote:
                              "The most beautiful and functional component library I've ever used. Highly recommended!",
                            rating: 5,
                          },
                          {
                            name: "Michael Park",
                            ...
                            quote:
                              "Incredible performance and stunning designs. Our team productivity increased by 300%!",
                            rating: 5,
                          },
                        ];

                        const currentIndex =
                          Math.floor(Date.now() / 3000) % testimonials.length;
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Interactive animations and effects like scratch-to-reveal
                      that engage users and enhance UX.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                    ...
                    >
                      ...
                      <div className="text-center space-y-4">
                        ...
                        <div className="relative group">
                          {/* Hidden reward */}
                          <motion.div
                            className="w-full h-40 mx-auto bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-lg flex flex-col items-center justify-center text-white font-bold text-xs relative overflow-hidden"
                            whileHover={{ scale: 1.05 }}
                            transition={{ type: "spring", stiffness: 300 }}
                          >
                        ...
                        <motion.p
                          className="text-xs text-muted-foreground"
                          animate={{
                            opacity: isFeature4Hovering ? [0.5, 1, 0.5] : 0.7,
                          }}
                          transition={{
                            duration: 2,
                            repeat: isFeature4Hovering ? Infinity : 0,
