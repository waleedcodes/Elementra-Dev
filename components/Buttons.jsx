...
const Buttons = React.forwardRef(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center transition-all duration-300 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed gap-2 active:scale-95 py-6";
    ...
    const variants = {
      ...
      elevated:
        "bg-purple-600 dark:bg-purple-700 text-white hover:translate-y-1 hover:bg-purple-800 dark:hover:bg-purple-800 rounded-lg shadow-lg hover:shadow-none transition-all animate-[transform_0.2s_ease]",
