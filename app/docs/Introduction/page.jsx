...
const Introduction = () => {
  return (
    <div className="container px-4 ">
      <h1 className="text-5xl font-bold mb-4">Elementra</h1>
      <p className="text-lg text-muted-foreground mb-12">
        Beautifully crafted components for modern UIs. Customizable. Accessible. Lightweight.
      </p>

      <section className="mb-12">
        <h2 className="text-2xl font-medium mb-4">What is Elementra?</h2>
        <p className="text-muted-foreground leading-relaxed">
          Elementra is a collection of reusable components that you can copy and paste into your projects. 
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-medium mb-4">What makes Elementra unique?</h2>
        <div className="grid gap-6">
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-950/30 dark:to-blue-950/30 p-6 rounded-xl border border-purple-100 dark:border-purple-900 hover:shadow-lg transition-all">
            ...
            <p className="text-muted-foreground">
              Elementra isn't distributed through npm. You pick the components you need, copy the code, and adapt it to your project.
            </p>
          </div>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-medium mb-4">How to Use Elementra</h2>
      ...
      <section>
        <h2 className="text-2xl font-medium mb-4">Why Choose Elementra?</h2>
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="p-4 rounded-lg border">
            <h3 className="font-medium mb-2">Design Freedom</h3>
            <p className="text-sm text-muted-foreground">Full access to code for complete customization.</p>
          </div>
          <div className="p-4 rounded-lg border">
            <h3 className="font-medium mb-2">Accessibility</h3>
            <p className="text-sm text-muted-foreground">Components are built to meet modern accessibility standards.</p>
          </div>
          <div className="p-4 rounded-lg border">
            <h3 className="font-medium mb-2">Efficiency</h3>
            <p className="text-sm text-muted-foreground">Streamline your workflow without adding unnecessary dependencies.</p>
          </div>
          <div className="p-4 rounded-lg border">
            <h3 className="font-medium mb-2">Reference Material</h3>
            <p className="text-sm text-muted-foreground">Use it as a foundation to build your own component libraries.</p>
          </div>
        </div>
      </section>
    </div>
