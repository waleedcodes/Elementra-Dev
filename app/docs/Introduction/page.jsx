...
const CodeSnippet = () => (
  <motion.div
    ...
    className="bg-gray-900 rounded-xl p-4 shadow-xl border border-gray-800 overflow-hidden"
  >
    ...
    <div className="relative min-h-screen text-gray-800 overflow-hidden w-full">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <motion.div
            variants={itemVariants}
            className="bg-white/80 rounded-3xl p-8 backdrop-blur-lg border border-gray-200 shadow-xl"
          >
        ...
        >
          {[
            ...
            >
              ...
              <div className="text-4xl font-bold mb-1 text-gray-800">{stat.value}</div>
