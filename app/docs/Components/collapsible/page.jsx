...
import { Copy, CopyIcon, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 text-foreground">Collapsible</h1>
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          An interactive component which expands and collapses container content sections.
        </p>
      </div>
      ...
      <div className="space-y-8 sm:space-y-12">
        ...
        <section className="space-y-4">
          ...
          <div className="relative">
            <div className="bg-card border border-border rounded-lg p-4 font-mono text-sm overflow-x-auto">
              <code className="text-foreground">npx elementra-ui add collapsible</code>
            </div>
          </div>
        </section>
                  ...
                  <div className="rounded-lg border border-border bg-background p-6 flex flex-col items-center justify-center min-h-[220px]">
                    <div className="w-full max-w-md bg-card border border-border rounded-lg p-4 space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-semibold text-foreground">@elementra-ui repository</span>
                      ...
                      {open && (
                        <div className="space-y-2 pt-2 text-xs border-t border-border">
                          <div className="p-2 rounded bg-muted/40 text-foreground font-mono">templates/components/ui/collapsible</div>
                          <div className="p-2 rounded bg-muted/40 text-foreground font-mono">templates/components/ui/alert-dialog</div>
                        </div>
                      )}
                    </div>
                  </div>
