...
export default function NavigationMenuDemo() {
  return (
    <NavigationMenu>
      <NavigationMenuList className="flex gap-4 text-sm font-medium">
        <NavigationMenuItem>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 text-foreground">Navigation Menu</h1>
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          A collection of links for navigating websites with dropdown menus and active state indicators.
        </p>
      </div>
              ...
              <AnimatePresence mode="wait">
                <TabsContent value="preview">
                  <div className="rounded-lg border border-border bg-background p-6 flex flex-col items-center justify-center min-h-[200px]">
                    <nav className="flex items-center gap-6 text-sm font-medium text-foreground bg-card px-6 py-3 rounded-full border border-border shadow-sm">
                      <span className="text-primary cursor-pointer">Overview</span>
                      <span className="hover:text-primary cursor-pointer text-muted-foreground">Components</span>
                      <span className="hover:text-primary cursor-pointer text-muted-foreground">Pricing</span>
                      <span className="hover:text-primary cursor-pointer text-muted-foreground">Docs</span>
                    </nav>
                  </div>
                </TabsContent>
...
export default NavigationMenuDocPage;
