...
const TooltipDocPage = () => {
  ...
  const codeExample = `import { Tooltip, TooltipTrigger, TooltipContent } from "@/components/ui/tooltip";
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 text-foreground">Tooltip</h1>
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          A popup element that displays helpful information when an element receives keyboard focus or hover.
        </p>
      </div>
                ...
                <TabsContent value="preview">
                  <div className="rounded-lg border border-border bg-background p-6 flex flex-col items-center justify-center min-h-[200px]">
                    <div className="group relative inline-block">
                      ...
                      <div className="absolute bottom-full mb-2 hidden group-hover:block bg-popover text-popover-foreground text-xs rounded py-1 px-2 border border-border shadow-md whitespace-nowrap">
                        Elementra UI Tooltip
                      </div>
                    </div>
                  </div>
                </TabsContent>
