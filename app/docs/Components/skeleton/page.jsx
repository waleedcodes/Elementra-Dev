  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 text-foreground">Skeleton</h1>
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          Use to show a placeholder while content is loading with smooth animated pulse shimmers.
        </p>
      </div>
