...
import { Copy, CopyIcon, Layers } from "lucide-react";
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 text-foreground">Popover</h1>
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          Displays rich content in a portal, triggered by a button or custom element.
        </p>
      </div>
            ...
            <Tabs defaultValue="preview" className="w-full">
              ...
              <AnimatePresence mode="wait">
                <TabsContent value="preview">
                  <div className="rounded-lg border border-border bg-background p-6 flex flex-col items-center justify-center min-h-[220px] relative">
                    <Button variant="outline" onClick={() => setOpen(!open)}>
                      Toggle Popover
                    </Button>
                    {open && (
                      <div className="absolute top-full mt-2 w-72 bg-card border border-border rounded-md p-4 shadow-xl z-20 space-y-2">
                        <h4 className="font-semibold text-sm text-foreground">Popover Title</h4>
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          This is rich popover content containing interactive elements and descriptions.
                        </p>
                      </div>
                    )}
                  </div>
