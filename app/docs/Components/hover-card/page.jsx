...
import { Copy, CopyIcon, Calendar } from "lucide-react";
import { Button } from "@/components/ui/button";
import { toast } from "sonner";
import { Tabs, TabsList, TabsTrigger, TabsContent } from "@/components/ui/tabs";
import { motion, AnimatePresence } from "framer-motion";

const HoverCardDocPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 text-foreground">Hover Card</h1>
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          For sighted users to preview content available behind a link or component on hover.
        </p>
      </div>
                ...
                <TabsContent value="preview">
                  <div className="rounded-lg border border-border bg-background p-6 flex flex-col items-center justify-center min-h-[220px]">
                    <div className="group relative inline-block">
                      <span className="text-primary underline font-medium cursor-pointer">@elementraui</span>
                      <div className="absolute bottom-full mb-2 hidden group-hover:block w-72 bg-card border border-border rounded-lg p-4 shadow-xl text-left z-20 space-y-2">
                        <h4 className="text-sm font-bold text-foreground">@elementraui</h4>
                        <p className="text-xs text-muted-foreground">
                          Modern reusable component library for React, Next.js, and Tailwind CSS.
                        </p>
                      </div>
                    </div>
                  </div>
