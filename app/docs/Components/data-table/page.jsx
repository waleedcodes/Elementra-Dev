...
const DataTableDocPage = () => {
  const codeExample = `import { DataTable } from "@/components/ui/data-table";
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 text-foreground">Data Table</h1>
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          Powerful data table component for displaying tabular data with sorting, filtering, and pagination.
        </p>
      </div>
              ...
              <AnimatePresence mode="wait">
                <TabsContent value="preview">
                  <div className="rounded-lg border border-border bg-background p-6 flex flex-col items-center justify-center min-h-[220px]">
                    <div className="w-full max-w-lg border border-border rounded-lg overflow-hidden text-sm">
                      <div className="bg-muted px-4 py-2 font-semibold flex justify-between border-b border-border text-foreground">
                        <span>User</span>
                        <span>Role</span>
                        <span>Status</span>
                      </div>
                      <div className="px-4 py-2.5 flex justify-between border-b border-border/50 text-muted-foreground">
                        <span>Alice Johnson</span>
                        <span>Admin</span>
                        <span className="text-green-500 font-medium">Active</span>
                      </div>
                      <div className="px-4 py-2.5 flex justify-between text-muted-foreground">
                        <span>Bob Smith</span>
                        <span>Developer</span>
...
export default DataTableDocPage;
