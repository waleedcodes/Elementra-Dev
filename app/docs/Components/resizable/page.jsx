  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8 sm:mb-12">
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 sm:mb-4 text-foreground">Resizable</h1>
        <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
          Accessible resizable panel groups and drag handles for creating flexible layout splits.
        </p>
      </div>
              ...
              <AnimatePresence mode="wait">
                <TabsContent value="preview">
                  <div className="rounded-lg border border-border bg-background p-6 flex flex-col items-center justify-center min-h-[220px]">
                    <div className="flex w-full max-w-md h-36 border border-border rounded-md overflow-hidden text-sm font-semibold">
                      <div className="w-1/2 bg-muted/30 flex items-center justify-center text-foreground">Panel Sidebar</div>
                      <div className="w-1 bg-border cursor-col-resize hover:bg-primary transition-colors" />
                      <div className="w-1/2 flex items-center justify-center text-foreground">Main Content</div>
                    </div>
                  </div>
                </TabsContent>
