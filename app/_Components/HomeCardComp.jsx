    ...
    <div className="min-h-screen bg-gradient-to-r from-[#0f172a] to-[#334155] py-20">
      ...
      >
        <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
          <Tabs defaultValue="preview" className="w-full backdrop-blur-lg bg-white/5 rounded-xl p-4 sm:p-6">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <TabsList className="grid w-full sm:w-[200px] grid-cols-2 bg-gray-800">
                <TabsTrigger value="preview" className="font-medium data-[state=active]:bg-purple-500 data-[state=active]:text-white">
                  Preview
                </TabsTrigger>
                <TabsTrigger value="code" className="font-medium data-[state=active]:bg-purple-500 data-[state=active]:text-white">
                  Code
                </TabsTrigger>
              </TabsList>
              <motion.div
              ...
              >
                ...
                >
                  <Copy className={`h-4 w-4 ${copied ? "text-green-500" : "text-gray-300"}`} />
                  {copied && (
                    <motion.span
                  ...
                  <Card className="w-full max-w-lg bg-gray-800 border-gray-700 shadow-xl md:p-4 p-2">
                    <CardHeader className="space-y-2">
                      ...
                      <CardDescription className="text-gray-400">
                        Experience the power of natural energy with our premium blend
                      </CardDescription>
                    </CardHeader>
      ...
      <Card className="max-w-md bg-gray-800 border-gray-700">
        ...
        <CardFooter className="flex justify-between items-center p-6">
          ...
          >
            <div className="pb-4">
              <motion.h1 
                className="text-4xl sm:text-6xl font-bold bg-gradient-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent pb-5"
            ...
            <div className="space-y-6">
              {[
                ...
                "Modern gradient effects with purple-pink color scheme",
