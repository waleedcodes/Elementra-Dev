...
export const metadata = {
  ...
  title: {
    default: "Elementra UI - Modern React Component Library | Build Beautiful UIs Fast",
    template: "%s | Elementra UI"
  },
  description: "Elementra UI is a production-ready React component library built with Next.js, Tailwind CSS, and Framer Motion. Create stunning, accessible, and responsive user interfaces with 50+ customizable components. Perfect for developers who want to build modern web applications quickly.",
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Build beautiful, accessible React applications with our comprehensive component library. 50+ components, TypeScript support, and production-ready.',
    images: [
      {
        url: '/logo2.png',
        width: 1200,
    ...
    "@graph": [
      {
        ...
        "url": "https://elementra-ui.vercel.app/",
        "name": "Elementra UI",
        "description": "Modern React Component Library for building beautiful UIs",
        "inLanguage": "en-US",
        "potentialAction": {
          "@type": "SearchAction",
          "target": {
            "@type": "EntryPoint",
            "urlTemplate": "https://elementra-ui.vercel.app/docs?search={search_term_string}"
          },
      ...
      },
      {
        ...
        "description": "Creating modern, accessible React components for developers worldwide",
        "foundingDate": "2024",
        "founder": {
          "@type": "Person",
          "name": "Waleed Codes",
      ...
      },
      {
        ...
        "name": "Elementra UI",
        "description": "A comprehensive React component library with 50+ components for building modern web applications",
        "url": "https://elementra-ui.vercel.app/",
